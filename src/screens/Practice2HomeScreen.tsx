...
export default function Practice2HomeScreen() {
  const navigation = useNavigation<NativeStackNavigationProp<RootStackParamList>>();
  const level2PracticeData = useStore((s) => s.level2PracticeData);

  const hasPracticeData = Object.keys(level2PracticeData).length > 0;
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Learn */}
      <Pressable style={styles.modeCard} onPress={() => navigation.navigate('Level2Learn')}>
      ...
      {/* Focus */}
      <Pressable style={styles.modeCard} onPress={() => navigation.navigate('Level2FocusSelection')}>
      ...
      <Pressable
        ...
        onPress={() => optimizeEnabled && navigation.navigate('Level2Optimize')}
