...
export default function Level2FocusSelectionScreen() {
  ...
  const savedSelection = useStore((s) => s.level2FocusSelection);
...
const styles = StyleSheet.create({
  ...
  cellSelected: { borderWidth: 3, backgroundColor: 'rgba(170,102,255,0.25)' },
